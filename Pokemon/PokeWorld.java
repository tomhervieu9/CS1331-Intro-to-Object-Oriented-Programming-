...
public class PokeWorld extends JPanel {
    ...
    /**
     * Once a Pokemon reaches level 100, they are taken out of the wild.
    ...
    private class ClickListener extends MouseAdapter {
        public void mousePressed(MouseEvent e) {
            ...
            if (types.size() < 1100) {
                ...
                } else if (pokemonSpecies.equals("Pikachu")) {
                    types.add(new Pikachu(p.x, p.y, bounds));
                } else if (pokemonSpecies.equals("Flareon")) {
                    types.add(new Flareon(p.x, p.y, bounds));
                }
            }
